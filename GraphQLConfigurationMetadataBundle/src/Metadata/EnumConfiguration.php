...
class EnumConfiguration extends MetadataConfiguration
{
    ...
    protected function getEnumName(ReflectionClass $reflectionClass, Meta $enumMetadata): string
    {
        return $enumMetadata->name ?? $reflectionClass->getShortName();
    }

    public function setClassesMap(ReflectionClass $reflectionClass, Meta $enumMetadata): void
    {
     ...
     */
    public function getConfiguration(ReflectionClass $reflectionClass, Meta $enumMetadata): array
    {
        $gqlName = $this->getEnumName($reflectionClass, $enumMetadata);
