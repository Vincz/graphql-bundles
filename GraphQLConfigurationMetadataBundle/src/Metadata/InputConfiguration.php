...
class InputConfiguration extends MetadataConfiguration
{
    ...
    protected function getInputName(ReflectionClass $reflectionClass, Meta $inputMetadata): string
    {
        return $inputMetadata->name ?? $this->suffixName($reflectionClass->getShortName(), 'Input');
    }

    public function setClassesMap(ReflectionClass $reflectionClass, Meta $inputMetadata): void
    {
     ...
     */
    public function getConfiguration(ReflectionClass $reflectionClass, Meta $inputMetadata): array
    {
        $gqlName = $this->getInputName($reflectionClass, $inputMetadata);
